...
export const TWIN_BLUEPRINTS = Object.freeze([
  ...
  },
  {
    ...
    skillIds: [
      ...
      skill("atelier-composition"),
      skill("character-composition"),
      skill("typography"),
  ...
  },
  {
    ...
    skillIds: [skill("creative-contracts"), skill("voice-performance"), skill("typography")],
  ...
  },
  {
    ...
    skillIds: [
      ...
      skill("editing-intelligence"),
      skill("b-roll-planning"),
