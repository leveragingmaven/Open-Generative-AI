...
import { createSkillLibrary } from "./SkillMetadata.js";

export const SKILL_LIBRARY = createSkillLibrary([
  productHeroPhotography,
  aiClipping,
  vibeMotion,
  recast,
  cameraPanTilt,
  cameraZoomLens,
  cameraDollyTracking,
  cameraPhysicalMovement,
  cameraHumanCamera,
  cameraDroneCrane,
  cameraSpecialTechniques,
  messageClarity,
  curiosityBuilding,
  humanConversation,
  trustBuilding,
