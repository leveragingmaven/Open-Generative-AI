...
export default function ImageStudio({
  ...
  // Featured result shown in the canvas (defaults to the most recent)
  const featuredIdx =
    ...
    const msgs = [
      {
        ...
        sender: "mavensync",
        content:
          "Welcome to Image Studio. Describe the image you want to create, pick a model and options in the composer, then hit Generate.",
        timestamp: "Image Studio",
      },
    ];
    if (prompt.trim()) {
      msgs.push({
  ...
  // ── Generation controls injected into the MavenSync composer ──────────
    ...
    <>
      ...
      <div className="relative">
        <button
          ...
          className={promptControlClassName({ active: dropdownOpen === "model" })}
        >
              ...
              return PROVIDER_LOGOS[selectedModelProvider] ? (
                <img
                  ...
                  className={`w-full h-full object-contain ${
                    invertLogos.includes(selectedModelProvider) ? "invert" : ""
                  }`}
                />
              ) : (
      ...
      <div className="relative">
        <button
          ...
          className={promptControlClassName({ active: dropdownOpen === "ar" })}
        >
          <PromptAspectRatioIcon />
      ...
      {showEffectBtn && (
        <div className="relative">
          <button
            ...
            className={promptControlClassName({ active: dropdownOpen === "effect" })}
          >
      ...
      <div className={promptControlClassName({ compact: true, className: "select-none" })}>
        ...
        <span className="text-xs font-semibold text-white/70 min-w-[24px] text-center">{batchSize}/4</span>
        <button
          type="button"
