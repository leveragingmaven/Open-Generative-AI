    ...
    <div className={wrapperClass}>
      <div className="w-full max-w-sm bg-[#0a0a0a]/90 backdrop-blur-xl border border-white/10 rounded-xl p-10 shadow-2xl relative">
        ...
        <div className="flex flex-col items-center text-center mb-10">
          <div className="w-14 h-14 bg-[#E82070]/5 rounded-2xl flex items-center justify-center border border-[#E82070]/10 mb-6 group hover:border-[#E82070]/30 transition-colors">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#E82070" strokeWidth="1.5" className="group-hover:scale-110 transition-transform">
          ...
          <p className="text-white/40 text-[13px] leading-relaxed px-4">
            {subtitle || (
              <>Enter your <a href="https://muapi.ai/access-keys" target="_blank" rel="noreferrer" className="text-[#E82070] hover:text-[#D4A858] transition-colors">Muapi.ai</a> API key to start creating</>
            )}
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full bg-white/5 border border-white/[0.03] rounded-md px-5 py-3 text-sm text-white placeholder:text-white/10 focus:outline-none focus:ring-1 focus:ring-[#E82070]/30 focus:bg-white/[0.07] transition-all"
          ...
          <button
            type="submit"
            className="w-full bg-[#E82070] text-white font-medium py-2.5 rounded-md hover:bg-[#f03a8b] hover:scale-[1.02] active:scale-[0.98] transition-all shadow-lg shadow-[#E82070]/10"
            suppressHydrationWarning
          >
            Get Started
          </button>
          ...
          <p className="text-center text-[12px] text-white/20 pt-2">
            Need a key?{' '}
            <a href="https://muapi.ai/access-keys" target="_blank" rel="noreferrer" className="text-white/40 hover:text-[#E82070] transition-colors font-medium">
              Get one free →
            </a>
          </p>
        </form>
